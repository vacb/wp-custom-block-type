...
wp.blocks.registerBlockType("vbplugin/custom-block-type", {
  ...
  save: function (props) {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", null, "Today the sky is really, really ", props.attributes.skyColour, " and the grass is very ", props.attributes.grassColour);
  },
  ...
  deprecated: [{
    ...
    save: function (props) {
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", null, "Today the sky is really ", props.attributes.skyColour, " and the grass is very ", props.attributes.grassColour);
    }
  }, {
    attributes: {
      skyColour: {
    ...
    save: function (props) {
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", null, "Today the sky is ", props.attributes.skyColour, " and the grass is", " ", props.attributes.grassColour);
    }
  }]
});
